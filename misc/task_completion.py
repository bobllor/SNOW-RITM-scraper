...
class TaskComplete:
    '''
    Class used to close out tasks on an RITM- this only allows manual input.

    Methods:
        1. TaskComplete.complete_asset closes out a given asset RITM completely- has three tasks to close out.
        2. TaskComplete.complete_return closes out a given return RITM completely- has four tasks to close out.
        3. TaskComplete.partial only closes out the first take of a given return RITM, used only after printing out labels.
    '''
